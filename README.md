...
The system currently supports patient management, appointment scheduling, and billing operations.
...
- Add new patients
- Automatically generate unique Patient IDs using UUID
...
- Store and display total billing amount
